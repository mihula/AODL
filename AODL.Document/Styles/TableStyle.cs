...
namespace AODL.Document.Styles
{
	public class TableStyle : IStyle
	{
		...
		public AODL.Document.Styles.Properties.TableProperties TableProperties
		{
			get
			{
				AODL.Document.Styles.Properties.TableProperties tableProperty;
				foreach (IProperty propertyCollection in this.PropertyCollection)
				{
					if (!(propertyCollection is AODL.Document.Styles.Properties.TableProperties))
					{
						continue;
					}
					tableProperty = (AODL.Document.Styles.Properties.TableProperties)propertyCollection;
					return tableProperty;
				}
				AODL.Document.Styles.Properties.TableProperties tableProperty1 = new AODL.Document.Styles.Properties.TableProperties(this);
				this.PropertyCollection.Add(tableProperty1);
				tableProperty = tableProperty1;
				return tableProperty;
			}
			set
			{
