...
namespace AODL.Document.Styles
{
	public class ColumnStyle : IStyle
	{
		...
		public AODL.Document.Styles.Properties.ColumnProperties ColumnProperties
		{
			get
			{
				AODL.Document.Styles.Properties.ColumnProperties columnProperty;
				foreach (IProperty propertyCollection in this.PropertyCollection)
				{
					if (!(propertyCollection is AODL.Document.Styles.Properties.ColumnProperties))
					{
						continue;
					}
					columnProperty = (AODL.Document.Styles.Properties.ColumnProperties)propertyCollection;
					return columnProperty;
				}
				AODL.Document.Styles.Properties.ColumnProperties columnProperty1 = new AODL.Document.Styles.Properties.ColumnProperties(this);
				this.PropertyCollection.Add(columnProperty1);
